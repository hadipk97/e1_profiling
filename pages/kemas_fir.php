                    ...
                    <div class="form group">
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <input type="text" class="form-control" disabled placeholder="Record ID (FIR)" value="<?php if(isset($_SESSION['id_fir'])) { echo $_SESSION['id_fir']; } ?>" width="50%" >
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <select name="priority" class="form-control" required>
                                    <option value="<?php if(isset($_SESSION['priority'])) { echo $_SESSION['priority']; } ?>"><?php if(isset($_SESSION['priority'])) { echo $_SESSION['priority']; } ?></option>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <select id="pilih" name="distribute" class="form-control">
                                	<option value="<?php if(isset($_SESSION['distribution'])) { echo $_SESSION['distribution']; } ?>"><?php if(isset($_SESSION['distribution'])) { echo $_SESSION['distribution']; } ?></option>
                           	...
                           	<div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <select name="cs_status" class="form-control" required>
                                    <option value="<?php if(isset($_SESSION['cs_status'])) { echo $_SESSION['cs_status']; } ?>"><?php if(isset($_SESSION['cs_status'])) { echo $_SESSION['cs_status']; } ?></option>
