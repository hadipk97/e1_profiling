        ...
        <div class="right_col" role="main">
          ...
          <div class="page-title">
              ...
              <div class="title_left">
                <h3>Senarai Keseluruhan Kes <strong><?php echo $_SESSION['status']; ?></strong> <?php echo $year; ?></h3>
              </div>
            </div>
            <div class="clearfix">
            <div class="row">
...
<?php 
      ...
      if ($role == 1 || $role == 2){
        $sql = "SELECT * FROM [jim].[dbo].[admin] where cs_status = '$_SESSION[status]' AND masa LIKE '%$year%' AND userk = '$fulln'";
      }else{
        $sql = "SELECT * FROM [jim].[dbo].[admin] where cs_status = '$_SESSION[status]' AND masa LIKE '%$year%'";
      }
